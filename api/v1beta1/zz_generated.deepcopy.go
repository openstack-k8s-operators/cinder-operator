...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CinderCephBackend) DeepCopyInto(out *CinderCephBackend) {
	*out = *in
	if in.CephPools != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CinderCephBackend.
func (in *CinderCephBackend) DeepCopy() *CinderCephBackend {
	if in == nil {
		return nil
	}
	out := new(CinderCephBackend)
	in.DeepCopyInto(out)
	return out
}
