...
// Package main is the entry point for the cinder-operator manager.
package main
...
import (
	...
	"github.com/openstack-k8s-operators/cinder-operator/internal/controller"
	webhookv1beta1 "github.com/openstack-k8s-operators/cinder-operator/internal/webhook/v1beta1"
...
func main() {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1beta1.SetupCinderWebhookWithManager(mgr); err != nil {
