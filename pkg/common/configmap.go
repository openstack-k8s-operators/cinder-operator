...
func GetConfigMaps(r ReconcilerCommon, obj runtime.Object, configMaps []string, namespace string, envVars *map[string]util.EnvSetter, configPrefix string) ([]cinderv1beta1.Hash, error) {
	...
	for _, cm := range configMaps {
		...
		hashes = append(hashes, cinderv1beta1.Hash{Name: cm, Hash: hash})
	}
