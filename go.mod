...
require (
	...
	github.com/openstack-k8s-operators/keystone-operator v0.0.0-20220816115324-87332bf11502 // indirect
	github.com/openstack-k8s-operators/lib-common/modules/database v0.0.0-20220818165433-9fcbeecefd3a // indirect
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.0.0-20220818165433-9fcbeecefd3a // indirect
	github.com/openstack-k8s-operators/mariadb-operator/api v0.0.0-20220805235246-83412d370fdb // indirect
