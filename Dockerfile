...
ARG IMAGE_COMPONENT="cinder-operator-container"
ARG IMAGE_NAME="cinder-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Cinder Operator"
ARG IMAGE_DESC="This image includes the cinder-operator"
